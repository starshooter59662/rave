...
const formatSong = (songData = {}) => {
    ...
    songArt = (song.art || 'https://cdn.discordapp.com/attachments/825737572051058692/876912878026883112/rave.png').replace(/159\.65\.16\.147/)g, 'oreo.itsrave.xyz';
    return {
        name: songTitle,
        artist: songArtist,
        album: songAlbum,
...
module.exports = async (req, res) => {
    ...
    try {
        let { body } = await got(`https://oreo.itsrave.xyz/api/nowplaying/${station}`);
